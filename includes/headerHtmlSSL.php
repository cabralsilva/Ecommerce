...
<link href="<?php echo URL_SSL; ?>css/_bower.css?v=1" rel="stylesheet" />
<link href="<?php echo URL_SSL; ?>css/geral.css?v=1" rel="stylesheet" />
<link href="<?php echo URL_SSL; ?>css/impressao.css?v=1" rel="stylesheet" media="print" />
<link rel="icon" type="image/png" href="<?php echo URL_SSL; ?>imagens/favicon.png" />
<script src="<?php echo URL_SSL; ?>bower_components/picturefill/dist/picturefill.min.js" async></script>
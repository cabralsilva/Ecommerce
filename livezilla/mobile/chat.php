...
<head>
    ...
    <script type="text/javascript" src="./js/lzm/classes/ChatCountries.js"></script>
...
<audio id="sound-queue" preload='auto'>
    <source src="sounds/queue.ogg" type="audio/ogg">
        ...
        <div class="lz-main" style="text-align:center;" id="chatframe">
            <div id="chat">
                ...
                <div id="qrd-tree" class="lzm-dialog">
                    ...
                    <div id="qrd-tree-headline" class="lzm-dialog-footline"></div>
                </div>

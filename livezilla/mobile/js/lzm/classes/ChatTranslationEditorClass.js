...
ChatTranslationEditorClass.prototype.showTranslationEditor = function(languages) {
    ...
    var footerString = lzm_inputControls.createButton('save-translation-editor', 'ui-disabled', '', t('Save'), '', 'lr',{'margin-left': '6px'},'',30,'d') +
        lzm_inputControls.createButton('cancel-translation-editor', '', '', t('Cancel'), '', 'lr',{'margin-left': '6px'},'',30,'d');
...
ChatTranslationEditorClass.prototype.createTranslationEditorHtml = function(myTab) {
    ...
    langSelHtml += '</tbody></table>' +
        ...
        '<div style="margin: 14px 0px;">' + lzm_inputControls.createButton(idPrefix + 'translation-language-new', 'translation-lang-btn', 'addTranslationLanguage(\'' + myTab + '\')', t('Add'), '', 'lr', {}, t('Add Language'),30,'e') + '</div>' +
        '<div style="margin: 14px 0px;">' + lzm_inputControls.createButton(idPrefix + 'translation-language-delete', 'translation-lang-btn ui-disabled', 'deleteTranslationLanguage(\'' + myTab + '\')', t('Delete'), '', 'lr', {}, t('Delete Language'),30,'e') + '</div>';
    langSelHtml += '<div style="margin: 14px 0px;">' + lzm_inputControls.createButton(idPrefix + 'translation-language-suggest', 'translation-lang-btn', 'suggestTranslationLanguage(\'' + myTab + '\')', t('Suggest as default'), '', 'lr', {}, t('Suggest translation as default'),30,'e') + '</div>' +

...
CommonServerEvaluationClass.prototype.addInternalUser = function (v) {
    ...
    if (typeof lzm_chatServerEvaluation != 'undefined') {
        if (new_user.userid == lzm_chatServerEvaluation.chosen_profile.login_name)
        {
            lzm_chatServerEvaluation.myGroup = new_user.groups[0];

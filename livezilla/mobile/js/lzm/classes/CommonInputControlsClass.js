...
CommonInputControlsClass.prototype.createOperatorList = function(tableid,groups,priorities,checkList){
    ...
    var operators = lzm_chatServerEvaluation.operators.getOperatorList('','',true,false);
...
CommonInputControlsClass.prototype.createInputControlPanel = function(mode, disabledClass) {
    ...
    if (mode != 'basic')
        panelHtml += lzm_inputControls.createButton('send-qrd', disabledClass, '', '', '<i class="fa fa-database"></i>', 'lr',{'margin-left': '4px'}, t('Knowledgebase'));
    return panelHtml;
};

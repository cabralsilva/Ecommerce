...
CommonDisplayLayoutClass.prototype.resizeLoginContainer = function() {
    ...
    $('#ldap_login').parent().css({display: (!lzm_commonDisplay.isApp) ? 'block' : 'none'});
    ...
    var thisOrientationButtonCss = (lzm_commonDisplay.isApp && appOs != 'ios' && appOs != 'windows' &&
        (minWidthHeight >= 290 || lzm_commonDisplay.orientation == 'horizontal')) ? {display: 'block'} : {'display': 'none'};

...
CommonDialogClass.prototype.createAlertDialog = function(errorMessage, buttons, wide, dim, shadow) {
    ...
    var dialogInnerHtml = '<div class="lzm-alert-dialog'+shadow+'" id="lzm-alert-dialog" data-do-init-editor-on-close="' + doInitEditorOnClose + '">' +
        '<div style="margin: 12px;">' + errorMessage + '</div>' +
        '<div style="margin: 32px 8px 12px 8px; text-align: right;">';
...
CommonDialogClass.prototype.changePassword = function(caller, password, callback) {
    ...
    var footerString = lzm_inputControls.createButton('change-password-ok', 'ui-disabled', '', t('Ok'), '', 'lr',{'margin-left': '6px', 'padding-left': '12px', 'padding-right': '12px', 'cursor': 'pointer'},'',30,'d') +
        lzm_inputControls.createButton('change-password-cancel', '', '', t('Cancel'), '', 'lr',{'margin-left': '6px', 'padding-left': '12px', 'padding-right': '12px', 'cursor': 'pointer'},'',30,'d');
...
CommonDialogClass.prototype.createPasswordChangeHtml = function() {
    var myHtml = '<fieldset id="change-password-inner" class="lzm-fieldset" data-role="none">' +
        ...
        '<div class="top-space"><label for="new-password">' + t('New password:') + '</label>' +
        '<input type="password" id="new-password" class="lzm-text-input" data-role="none" /></div>' +
        '<div class="top-space"><label for="confirm-password">' + t('New password repetition:') + '</label>' +
...
CommonDialogClass.prototype.createDialogWindow = function(headerString, bodyString, footerString, id,
    ...
    var key;
    var htmlContents = '<div id="' + id + '-container" class="dialog-window-container cm-click"><div id="' + id + '" onclick="event.stopPropagation();" class="dialog-window' + classnameExtension + '"><div id="' + id + '-headline" class="dialog-window-headline' + classnameExtension + '">' + headerString;

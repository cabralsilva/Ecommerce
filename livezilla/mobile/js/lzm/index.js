...
var createLoginForm = function(profileIndex, userStatus) {
    ...
    var loginForm = lzm_inputControls.createInput('username', 'login-input', '', 'Username', '<i class="fa fa-user"></i>', 'text', 'a') +
        ...
        lzm_displayHelper.createSelect('user_status', '', '', '', false, {background: '#888', border: '2px solid #fff', width: '90px', color: '#fff', 'border-radius': '0px','border-bottom-left-radius': '14px', 'border-top-left-radius': '14px', padding: '6px 0 6px 12px'}, '', optList, userStatus,'') +

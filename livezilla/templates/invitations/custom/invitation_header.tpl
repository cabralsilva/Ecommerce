<table cellspacing="0" cellpadding="0" style="margin:0px;padding:0px;border:0px;background-repeat:no-repeat;background-position:center left;" width="302" height="302" border="0">
	<tr>
...
<div style="position:absolute;left:10px;top:120px;"><img src="<!--server--><!--intern_image-->" border="0"></div>
...
<input type="text" value="<!--username-->" id="lz_invitation_name" maxlength="32" style="position:absolute;left:11px;top:262px;background-repeat:no-repeat;border:0px;height:20px;width:164px;font-size:11px;color:#707070;padding-left:3px;line-height:15px;outline:none;">

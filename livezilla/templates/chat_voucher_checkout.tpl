	...
	<table style="width:100%">
		<tr>
			<td style="text-align:center;">
                <table class="lz_input_header" id="lz_input_header_box">
                    <tr>
                        <td style="width:5px;"></td>
                        <td style="text-align:center;vertical-align:middle;" id="lz_header_type_icon">
                            <img src="./images/chat_header_icon_cout.png" alt="">
                        </td>
                        <td style="vertical-align:middle;">
                            <span id="lz_header_title"><!--lang_client_voucher_select--></span><br>
                            <span id="lz_form_info_field" class="lz_input_info_field"><!--lang_client_voucher_select_info--></span>
                        </td>
                        <td></td>
                    </tr>
                </table>
                <br><br>
				<!--voucher_form-->
				<table style="width:430px;margin:10px auto;">
					<tr>
						<td colspan="3"></td>
					</tr>
					<tr>
			...
			<td align="center" valign="top">
                ...
                <table class="lz_input_header" id="lz_input_header_box">
                    <tr>
                        ...
                        <td style="vertical-align:middle;">
                            <span id="lz_header_title"><!--lang_client_terms_of_service--></span><br>
                            <span id="lz_form_info_field" class="lz_input_info_field"><!--lang_client_terms_of_service_info--></span>
                        </td>
                        <td></td>
                    </tr>
                </table>
...
<div id="lz_chat_checkout_details" style="display:none;overflow:auto;height:100%;">
	<form action="<!--server-->checkout.php" id="checkout_form" method="POST" target="_top">
        ...
        <input type="hidden" name="form_ofc" value="<!--ofc-->">
				...
				<td align="center" valign="top">
                    ...
                    <table class="lz_input_header" id="lz_input_header_box">
                        <tr>
                            ...
                            <td style="vertical-align:middle;">
                                <span id="lz_header_title"><!--lang_client_customer_information--></span><br>
                                <span id="lz_form_info_field" class="lz_input_info_field"><!--lang_client_customer_information_info--></span>
                            </td>
                            <td></td>
                        </tr>
                    </table>
                        ...
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_email" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_firstname" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_lastname" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_address_1" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_city" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_zip" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                        ...
                        <table class="lz_input" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width:20px;padding:2px;"><div class="lz_input_icon lz_required" id="lz_form_checkout_mandatory_country" style="display:none;"></div></td>
                            </tr>
                        </table>
                        <br><br><br>
                        <table class="lz_chat_voucher_navigation">

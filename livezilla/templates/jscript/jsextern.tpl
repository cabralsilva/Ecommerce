...
var lz_oak = '';
var lz_is_ie = <!--is_ie-->;
var ticket_disabled = !<!--function_ticket-->;
...
function lz_chat_release(_chatPossible, _setupError)
{
	...
	else
	{
        ...
        lz_chat_get_frame_object('lz_tab_ticket').style.display = (!ticket_disabled) ? "" : "none";
...
function lz_chat_tab_set_active(_application, _userActivity)
{
    try
    {
        ...
        if(_application == "ticket" && ticket_disabled)
            _application = "chat";
        ...
        else if(_application == "chat")
        {
            ...
            lz_chat_get_frame_object('lz_form_details').style.display = (lz_chat_data.ChatGroupAvailable || ticket_disabled) ? "" : "none";

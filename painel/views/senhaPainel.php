...
<head>
<meta charset="utf-8" />
<title>Alterar Senha - Painel do Usuário</title>
	...
	<div class="carrinho painel">
		...
		<div class="conteudo">
			...
			<div class="limites">
				...
				<form action="<?= UrlSite . BasePainel ?>/controllers/senhaController.php" method="POST" class="alterar-senha">
					<fieldset>
						<h3>Alterar senha</h3>
						<ol>
							<li class="obrigatorio"><label for="senha-atual">Senha atual</label><input
								class="pwd" type="password" name="senha-atual" id="senha-atual" required="required"></li>
							<li class="obrigatorio"><label for="senha-nova">Senha nova</label><input
								class="pwd" type="password" name="senha-nova" id="senha" required="required"></li>
							<li class="obrigatorio"><label for="confirmacao">Confirmar senha nova</label><input
								class="pwd" type="password" name="confirmacao" id="confirmacao" required="required"></li>
						</ol>
						<label><input type="checkbox" name="mostrar-senha"
							...
							Mostrar senha</label> <a href="index.html" class="voltar"
							title="Voltar ao site"><svg width="8px" height="15px">
	...
	<script type="text/javascript">
		...
		function validatePassword(){
		  if(password.value != confirm_password.value) {
		    confirm_password.setCustomValidity("Senhas novas não são iguais");
		  } else {

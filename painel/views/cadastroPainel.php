...
if (! isset ( $_SESSION ["PEDIDO"]["USUARIO"] )) { // verifica se está logado
	header ( "Location: " . UrlSite . BasePainel . "/loginPainel" );
	die ();
}else if ( isset ( $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["pessoa"] ) && $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["pessoa"] == "juridica"){
	header ( "Location: " . UrlSite . BasePainel . "/editarpj" );
	die ();
}
		...
		<div class="conteudo">
			...
			<div class="limites">
				...
				<?php if ($_SESSION["PEDIDO"]["USUARIO"] == "NOVO"){?>
					<ul class="abas">
						<li class="ativo"><a href="<?= UrlSite . BasePainel ?>/editarpf" title="Dados de pessoa física">Pessoa física</a></li>
						<li><a href="<?= UrlSite . BasePainel ?>/editarpj" title="Dados de pessoa jurídica">Pessoa jurídica</a></li>
					</ul>
				<?php }?>
				<form action="<?= UrlSite . BasePainel ?>/controllers/cadastroController.php?acao=editar" class="conta" method="POST">
					<input type="hidden" id="pessoa" name="pessoa" value="<?= ($_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["pessoa"] : "fisica" ?>">
					<fieldset>
						<section>
							<h3>Dados pessoais</h3>
							<ol>
								<li class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["nome"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> obrigatorio"><label for="nome-completo">Nome
										completo</label><input required="required" type="text" name="nome-completo" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["nome"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]] ["nome"] : "" ?>"
									id="nome-completo"> <span>Por favor, preencha seu nome</span></li>
								<li class="obrigatorio"><label for="data-nascimento">Data de
										nascimento</label><input required="required" class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["data_nascimento"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> pequeno" type="date"
									name="data-nascimento" id="data-nascimento" value="<?= (isset( $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["data_nascimento"])) ?  $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["data_nascimento"] : ""?>"
									placeholder="dd/mm/aaaa"></li>
								<li>
									<ul>
										<li class="obrigatorio"><label for="cpf">CPF</label><input required="required" value="<?=$_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cpf"]?>"
											class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cpf"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> medio" type="text" name="cpf" id="cpf"></li>
										<li class="obrigatorio"><label for="rg">RG</label><input required="required" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["rg"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["rg"] : "" ?>"
											class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["rg"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> medio" type="text" name="rg" id="rg"></li>
									</ul>
								</li>
								<li class="obrigatorio"><label for="email">Endereço de e-mail</label>
									<input required="required" value="<?= ($_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["email"] : $_SESSION["email"] ?>" readonly
										class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["email"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> medio" 
								...
								<li>
									<ul>
										<li class="obrigatorio"><label for="telefone">Telefone</label>
											<input required="required" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["ddd1"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["ddd1"] . $_SESSION['USUARIO']['telefone1'] : "" ?>"
												class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["ddd1"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> medio" type="tel" name="telefone" id="telefone"></li>
										<li><label for="telefone2">Outro telefone</label>
											<input value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["ddd2"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["ddd2"] . $_SESSION['USUARIO']['telefone2'] : "" ?>"
											class="medio" type="tel" name="telefone2" id="telefone2"></li>
									</ul>
								</li>
							</ol>
						</section>
						...
						<section>
							...
							<ol>
								<li class="obrigatorio">
									...
									<ul>
										<li><input required="required" class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cep1"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> cep" type="text" name="cep1" id="cep1" 
											value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cep1"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cep1"] : "" ?>"
											title="Digite o CEP"></li>
										<li><input required="required" class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cep2"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> cep-menor" type="text" name="cep2" id="cep2" 
											value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["email"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cep2"] : "" ?>"
											title="Digite o CEP"></li>
									</ul>
								</li>
								<li>
									<ul>
										<li class="obrigatorio"><label for="endereco">Endereço</label><input  required="required" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["endereco"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["endereco"] : "" ?>"
											class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["endereco"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> grande" type="text" name="endereco" id="endereco"></li>
										<li class="obrigatorio"><label for="endereco-numero">Número</label><input required="required" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["numero"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["numero"] : "" ?>"
											class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["numero"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> cep" type="text" name="endereco-numero"
											id="endereco-numero"></li>
									</ul>
								</li>
								<li>
									<ul>
										<li><label for="complemento">Complemento</label><input value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["complemento"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["complemento"] : "" ?>"
											class="medio" type="text" name="complemento" id="complemento"></li>
										<li class="obrigatorio"><label for="bairro">Bairro</label><input required="required" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["bairro"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["bairro"] : "" ?>"
											class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["bairro"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> medio" type="text" name="bairro" id="bairro"></li>
									</ul>
								</li>
								<li>
									<ul>
										...
										<li class="obrigatorio"><label for="cidade">Cidade</label><input required="required" value="<?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cidade"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cidade"] : "" ?>"
											class="<?= (!isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["cidade"]) && $_SESSION["PEDIDO"]["USUARIO"] == "CADASTRADO") ? "erro" : "" ?> medio" type="text" name="cidade" id="cidade"></li>
									</ul>
								</li>
								<li><label for="pontos">Pontos de referência</label>
								<textarea name="pontos" id="pontos" cols="30" rows="10" ><?= (isset($_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["informacoes_referencia"])) ? $_SESSION[$_SESSION["PEDIDO"]["USUARIO"]]["informacoes_referencia"] : "" ?></textarea></li>
							</ol>
						</section>
						<?php if ($_SESSION["PEDIDO"]["USUARIO"] == "NOVO"){?>
							<ul>
								...
								<li class="obrigatorio"><label for="confirmacao">Confirmar senha</label>
									<input class="pwd" type="password" name="confirmacao" id="confirmacao" required="required"></li>
...
<!-- 								<use xlink:href="#icone-seta" class="icone" /></svg> -->
  ...
  185.615,206.828 350.018,371.23 371.23,350.018 206.828,185.615 " />                </symbol>
	...
	<!-- abre scripts -->
	<script
		src="<?= UrlSite . BasePainel ?>/resources/bower_components/jquery/dist/jquery.min.js"></script>
	<script src="<?= UrlSite . BasePainel ?>/resources/js/plugins.min.js"></script>
	<script src="<?= UrlSite . BasePainel ?>/resources/js/_bower.min.js"></script>
	<script src="<?= UrlSite . BasePainel ?>/resources/js/main.min.js" defer></script>
	<script src="<?= UrlSite . BasePainel ?>/resources/js/jquery-maskinput-1.1.4.js" defer></script>
	<!-- fecha scripts -->
	...
	$(document).ready(function(){
	    ...
	    $("#cep2").keyup(function(e) {
			...
			if (cepCampo1.length == 5 && $("#cep2").val().length == 3) {
				...
				$.ajax({
					url: "<?= UrlSite . BasePainel ?>/util/inputCepXml.php",
					data: dados,

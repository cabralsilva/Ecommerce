<?php
	...
	//if ($_POST["code"] == $_SESSION["security_code"]){ //captcha
		if (@$_GET["cod_prod_grade"]!=""){
			...
			//$_html .= "<br><br><strong>Página Atual: </strong>" . $_SERVER['PHP_SELF'] . "<br><br>";
			//$_html .= "<strong>URL: </strong>" . $_SERVER['SERVER_NAME'] . $_SERVER ['REQUEST_URI'] . "<br><br>";
			//$_html .= "<strong>Browser: </strong>" . getBrowser() . "<br><br>";
			//$_html .= "<strong>Página Anterior: </strong>" . (isset($_SERVER['HTTP_REFERER'])?$_SERVER['HTTP_REFERER']:"Não identificada") . "<br><br>";
			...
			//die("<script> window.location.href='" . URL . "index'; </script>");	

...
if (@$_GET ["tipo"] == "0") {
	...
	if ($_frete != "n") {
		...
		session_start();
		$_SESSION["PEDIDO"]["fretes_disponiveis"]["0"] = str_replace ( ',', '.', $_array["valor_pac"] );
		$_SESSION["PEDIDO"]["fretes_disponiveis"]["1"] = str_replace ( ',', '.', $_array["valor_sedex"] );
		$_SESSION["PEDIDO"]["fretes_disponiveis"]["2"] = 0;
		$_SESSION["PEDIDO"]["fretes_disponiveis"]["3"] = 0;

...
<body itemscope itemtype="http://schema.org/WebPage">
	...
	<div class="carrinho">
		...
		<header class="topo">
			...
			<div class="limites">
				<h1>
					<a href="index.html" title="Voltar à página inicial"><img
						src="imagens/logo.png" alt="Plander.com"></a>
				</h1>
				<ul class="contatos">
					<li><a href="#" title="Visitar o Atendimento Online"><svg
								width="23px" height="20px">
								<use xlink:href="#icone-atendimento" class="icone" /></svg>
							Atendimento Online</a></li>
					<li class="telefone"><strong><svg width="20px" height="20px">
								<use xlink:href="#icone-telefone" class="icone" /></svg>
							Televendas | (41) 3323-3636</strong></li>
					<li class="whatsapp"><strong><img src="imagens/icone-whatsapp.png"
							alt="WhatsApp"> (41) 9896-1818</strong></li>
				</ul>
			</div>
			<!-- fecha .limites -->
		...
		<div class="conteudo">
			...
			<div class="limites">
				...
				<header>
					<h2>Pagamento</h2>
					<ol class="passos">
						<li class="check"><svg width="24px" height="20px">
								<use xlink:href="#icone-carrinho" class="icone" /></svg>
							Carrinho</li>
						<!--           <li class="check"><svg width="20px" height="20px"><use xlink:href="#icone-usuario" class="icone" /></svg> Identificação</li> -->
						<li class="ativo"><svg width="24px" height="20px">
								<use xlink:href="#icone-cartoes" class="icone" /></svg>
							Pagamento</li>
						<li><svg width="26px" height="20px">
								<use xlink:href="#icone-check" class="icone" /></svg>
							Confirmação</li>
					</ol>
				</header>

				<div class="resumo-pedido">
					<p>Informe abaixo os dados para contato e entrega do(s) seu(s)
						item(ns), em seguida informe a forma de pagamento</p>

					<ul class="abas">
						<li class="ativo"><a href="carrinhoPagamentoSemCadastro"
							title="Dados de pessoa física">Pessoa física</a></li>
						<li><a href="carrinhoPagamentopjSemCadastro"
							title="Dados de pessoa jurídica">Pessoa jurídica</a></li>
					</ul>

					<form action="<?php echo URL_SSL; ?>actions/finalizarPedidoSemCadastro.php" class="conta" method="POST" onsubmit="return mySubmit()">
						<input type="hidden" id="pessoa" name="pessoa" value="fisica">
						<fieldset>
							<section class="esquerda">
								<h3>Dados pessoais</h3>
								<ol>
									<li class="obrigatorio"><label for="nome-completo">Nome
											completo</label> <input required="required" type="text"
										name="nome-completo" id="nome-completo"> <span>Por favor,
											preencha seu nome</span></li>
									<li>
										<ul>
											<li class="obrigatorio"><label for="cpf">CPF</label><input
												required="required" class="medio" type="text" name="cpf"
												id="cpf"></li>
											<li class="obrigatorio"><label for="rg">RG</label><input
												required="required" class="medio" type="text" name="rg"
												id="rg"></li>
										</ul>
									</li>
									<li class="obrigatorio"><label for="email">Endereço de e-mail</label><input
										required="required" class="medio" type="email" name="email"
										id="email"> <small>(será usado como usuário)</small></li>
									<li>
										<ul>
							...
							<section class="direita">
								...
								<ol>
									<li class="obrigatorio">
										...
										<ul>
											<li><input required="required" class="cep medio" type="text"
												name="cep" id="cep" title="Digite o CEP"></li>
										</ul>
									</li>
									<li>
										<ul>
											<li class="obrigatorio"><label for="endereco">Endereço</label><input
												required="required" class="grande" type="text"
												name="endereco" id="endereco"></li>
											<li class="obrigatorio"><label for="endereco-numero">Número</label><input
												required="required" class="cep" type="text"
												name="endereco-numero" id="endereco-numero"></li>
										</ul>
									</li>
									<li>
										<ul>
											<li><label for="complemento">Complemento</label><input
												class="medio" type="text" name="complemento"
												id="complemento"></li>
											<li class="obrigatorio"><label for="bairro">Bairro</label><input
												required="required" class="medio" type="text" name="bairro"
												id="bairro"></li>
										</ul>
									</li>
									<li>
                        ...
                        <?php
											...
											<li class="obrigatorio"><label for="cidade">Cidade</label><input
												required="required" class="medio" type="text" name="cidade"
												id="cidade"></li>
										</ul>
									</li>
									<li><label for="pontos">Pontos de referência</label>
									<textarea name="pontos" id="pontos" cols="30" rows="10"></textarea></li>
								</ol>
							</section>
						</fieldset>
						...
						<fieldset class="pedido">
							<h3>Meu pedido</h3>
							<table class="compras tablesaw tablesaw-stack"
							...
							<a href="<?= URL_SSL ?>carrinho" class="voltar" title="Editar carrinho"><svg
									width="8px" height="15px">
									<use xlink:href="#icone-seta" class="icone" /></svg> Editar
								carrinho</a>
						</fieldset>
...
<!-- 									name="documento" id="documento"></li> -->
							...
							<button class="action" title="Confirmar compra">
								Confirmar
		...
		<footer class="rodape">
			...
			<div class="limites">
				<div>
					...
					<ul class="seguranca centro">
						...
						<li><img src="imagens/seguranca-correios.jpg"
							alt="Entrega garantida Correios"></li>
			...
			<p class="copyright centro">
				&copy; 2015 Plander.com – Todos os direitos reservados <span>| CNPJ:
					12345678/1234-12 |</span> Rua Alferes Poli, 620 - Centro -
				Curitiba, PR
			</p>
	...
	<svg style="display: none;">
		...
		<title>Shape</title>
		<g id="alerta-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="alerta-Produto" transform="translate(-999 -482)"
			fill="currentColor" sketch:type="MSArtboardGroup"> <g
			id="alerta-detalhes" transform="translate(28 374)"
			sketch:type="MSLayerGroup"> <g id="alerta-indispon&#xED;vel"
			sketch:type="MSShapeGroup" transform="translate(971 108.5)"> <g
			id="alerta-triangle38"> <g id="alerta-Group"> <path id="alerta-Shape"
		...
		<title>Shape</title>
		<g id="atendimento-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="atendimento-P&#xE1;gina-Inicial"
			transform="translate(-589 -28)" fill="currentColor"
			sketch:type="MSArtboardGroup"> <g id="atendimento-topo"
			sketch:type="MSLayerGroup"> <g id="atendimento-nav"
			sketch:type="MSShapeGroup" transform="translate(28 25)"> <g
			id="atendimento-atendimento" transform="translate(561.5 3.1855)"> <g
			id="atendimento-Group"> <path id="atendimento-Shape"
		...
		<title>lupa</title>
		<g id="busca-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="busca-P&#xE1;gina-Inicial"
		...
		<g id="carrinho-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="carrinho-P&#xE1;gina-Inicial"
			transform="translate(-1170 -142)" fill="currentColor"
			sketch:type="MSArtboardGroup"> <g id="carrinho-topo"
			sketch:type="MSLayerGroup"> <g id="carrinho-compras"
			sketch:type="MSShapeGroup" transform="translate(1161 135)"> <g
			id="carrinho-carrinho" transform="translate(9 7)"> <path
			id="carrinho-Shape"
		...
		<title>credit2</title>
		<g id="cartoes-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="cartoes-Carrinho"
		...
		<g id="check-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="check-Carrinho" transform="translate(-1201 -110)"
			fill="currentColor" sketch:type="MSArtboardGroup"> <g
			id="check-carrinho" transform="translate(30 110)"
			sketch:type="MSLayerGroup"> <g id="check-passos"
			sketch:type="MSShapeGroup" transform="translate(777)"> <g
  ...
  185.615,206.828 350.018,371.23 371.23,350.018 206.828,185.615 " />                </symbol>
		...
		<title>truck</title>
		<g id="frete-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="frete-P&#xE1;gina-Inicial"
		...
		<title>Group</title>
		<g id="mail-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="mail-Produto" transform="translate(-1034 -625)"
			fill="currentColor" sketch:type="MSArtboardGroup"> <g
			id="mail-detalhes" transform="translate(28 374)"
			sketch:type="MSLayerGroup"> <g id="mail-mail"
			sketch:type="MSShapeGroup" transform="translate(1006 251)"> <g
			id="mail-Group"> <path id="mail-Shape"
		...
		<g id="seta-baixo-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="seta-baixo-P&#xE1;gina-Inicial"
			transform="translate(-1098 -160)" fill="currentColor"
			sketch:type="MSArtboardGroup"> <g id="seta-baixo-topo"
		...
		<title>Shape</title>
		<g id="seta-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="seta-P&#xE1;gina-Inicial"
		...
		<title>Shape</title>
		<g id="telefone-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="telefone-P&#xE1;gina-Inicial"
			transform="translate(-785 -28)" fill="currentColor"
			sketch:type="MSArtboardGroup"> <g id="telefone-topo"
			sketch:type="MSLayerGroup"> <g id="telefone-nav"
			sketch:type="MSShapeGroup" transform="translate(28 25)"> <g
		...
		<title>user168</title>
		<g id="usuario-Desktop" fill-rule="evenodd" sketch:type="MSPage"
			fill="none"> <g id="usuario-Carrinho"
	...
	<!-- abre scripts -->
	<script
		src="painel/resources/bower_components/jquery/dist/jquery.min.js"></script>
	<script src="painel/resources/js/plugins.min.js"></script>
	<script src="painel/resources/js/_bower.min.js"></script>
	<script src="painel/resources/js/main.min.js" defer></script>

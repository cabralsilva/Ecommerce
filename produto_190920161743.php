          ...
          <div class="dropdown">
            ...
            <form target="iframeOp" action="<?php echo URL; ?>actions/indiqueProduto.php?cod_prod_grade=<?php echo $_codProdutoGrade; ?>" method="POST" onsubmit="return mySubmit();">
              <fieldset>
                ...
                <ol>
                  <li><label for="nome-amigo">Nome do amigo:</label><input type="text" name="nome-amigo" id="nome-amigo"></li>
                  <li><label for="email-amigo">E-mail do amigo:</label><input type="text" name="email-amigo" id="email-amigo"></li>
                  <li><label for="mensagem-indicacao">Mensagem:</label><textarea name="mensagem-indicacao" id="mensagem-indicacao" rows="5" cols="30"></textarea></li>
                  <li><label for="seu-nome">Seu nome:</label><input type="text" name="seu-nome" id="seu-nome"></li>
                  <li><label for="seu-email">Seu e-mail:</label><input type="text" name="seu-email" id="seu-email"></li>
                </ol>
...
<script>
	...
	function mySubmit(){
		...
		myList.push($('input[name=nome-amigo]'));
		myList.push($('input[name=email-amigo]'));
		myList.push($('input[name=seu-nome]'));
		myList.push($('input[name=seu-email]'));

...
<?php
	$dir = "../" . $_SESSION["pasta_ftp"] . "/" .$_SESSION["s_sub_pasta_ftp"];
	//echo "$dir";
	$contents = array();
...
echo "<ul id=\"sortable_banner\" class=\"sortable\">";
	...
	echo "<li class=\"ui-state-default\" id=\"" . ($contents[$_i]) . "\">";
		...
		?>
			...
			<?php if($pasta_ftp == "public_html/banners") {?>
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<?php
	...
	*/
	...
	$_SESSION["s_link_ftp"]         = $_REQUEST['link_ftp']."/".$_REQUEST['pasta_ftp']."/".$_REQUEST['sub_pasta_ftp']; 
	...
	$_SESSION["s_pasta_ftp"]        = "public_html/ibolt/homologacao/".$_REQUEST['pasta_ftp']; 
	$_SESSION["pasta_ftp"]        = $_REQUEST['pasta_ftp']; 
	...
	//exit; - 
//Realiza a conexão
//$conexao_ftp = ftp_connect( $servidor_ftp )or die("Erro conexao");
//print_r($conexao_ftp);
//Tenta fazer login
//$login_ftp = ftp_login( $conexao_ftp, $usuario_ftp, $senha_ftp ) or die("Erro login");

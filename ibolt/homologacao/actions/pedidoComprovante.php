		                    ...
		                    <table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\">
		                      ...
		                      <tr>
		                        <td align=\"center\" style=\"border-top: 1px solid #E2E2E2\">
		                          ...
		                          $_html .= (($_pedidoForma=="boleto" || $_pedidoForma=="Boleto") && $_situacao=="pedido"?"<a href=\"" . URL . "boleto/boleto_bradesco.php?id=" . $_pedidoId . "\" target=\"_blank\" title=\"Imprimir boleto\"><img src=\"http://clientes.coopers.pro/plander/imagens/email-botao-imprimir.jpg\" alt=\"Imprimir boleto\" border=\"0\" width=\"212\" height=\"41\"></a><br>":"");

		                          $_html .= (($_pedidoForma=="boleto" || $_pedidoForma=="Boleto") && $_situacao=="pedido"?"<em style=\"font-size: 11px; color: #9B9B9B\">Caso não tenha impresso seu boleto, clique no link acima.</em>":"");	                         

...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cadastro - Carrinho de Compras - Plander.com</title>
    ...
    <link href="css/_bower.css?v=1" rel="stylesheet" />
...
<div class="carrinho">
  ...
  <header class="topo">
    ...
    <!-- abre .limites -->
    <div class="limites">
      <h1><img src="imagens/logo.png" alt="Plander.com"></h1>
      <ul class="contatos">
  ...
  <div class="conteudo">
    ...
    <div class="limites">
      ...
      <form action="actions/gravarCliente.php?tabela=<?php echo TB_CLIENTE; ?>&acao=novo" method="POST" onsubmit="return mySubmit();" class="conta">
        <fieldset>
          <section id="section_fisica">
            <h3>Dados pessoais</h3>
            <ol>
              <li class="obrigatorio"><label for="nome-completo">Nome completo</label><input type="text" name="nome-completo" id="nome-completo"> 
              	<!--<span>Por favor, preencha seu nome</span></li>-->
              <li class="obrigatorio"><label for="data-nascimento">Data de nascimento</label><input class="pequeno" type="date" name="data-nascimento" id="data-nascimento" placeholder="dd/mm/aaaa"></li>
              <li>
                <ul>
                  <li class="obrigatorio"><label for="cpf">CPF</label><input class="medio" type="text" name="cpf" id="cpf"></li>
                  <li class="obrigatorio"><label for="rg">RG</label><input class="medio" type="text" name="rg" id="rg"></li>
                </ul>
              </li>
              <li class="obrigatorio"><label for="email">Endereço de e-mail</label><input class="medio" type="email" name="email-fisica" id="email-fisica" value="<?php echo @$_SESSION["email"]; ?>"> <small>(será usado como usuário)</small></li>
              <li>
                <ul>
                  <li class="obrigatorio"><label for="ddd">DDD</label><input class="medio" type="tel" name="ddd-fisica" id="ddd-fisica"></li>
                  <li class="obrigatorio"><label for="telefone">Telefone</label><input class="medio" type="tel" name="telefone-fisica" id="telefone-fisica"></li>
                </ul>
              </li>
              <li>
                <ul>
                  <li><label for="ddd2">DDD</label><input class="medio" type="tel" name="ddd2-fisica" id="ddd2-fisica"></li>
                  <li><label for="telefone2">Outro telefone</label><input class="medio" type="tel" name="telefone2-fisica" id="telefone2-fisica"></li>
                </ul>
              </li>
            </ol>
          </section>
          ...
          <section id="section_juridica">
            ...
            <ol>
              <li class="obrigatorio"><label for="razao-social">Razão social</label><input type="text" name="razao-social" id="razao-social">
              	 <!--<span>Por favor, preencha a razão social da empresa</span></li>-->
              <li>
                <ul>
                  <li class="obrigatorio"><label for="cnpj">CNPJ</label><input class="medio" type="text" name="cnpj" id="cnpj"></li>
                  <li class="obrigatorio"><label for="ie">Inscrição Estadual</label><input class="medio" type="text" name="ie" id="ie"></li>
                </ul>
              </li>
              <li class="obrigatorio"><label for="email">Endereço de e-mail</label><input class="medio" type="email-juridica" name="email-juridica" id="email" value="<?php echo @$_SESSION["email"]; ?>"> <small>(será usado como usuário)</small></li>
              <li>
                <ul>
                  <li class="obrigatorio"><label for="ddd">DDD</label><input class="medio" type="tel" name="ddd-juridica" id="ddd-juridica"></li>
                  <li class="obrigatorio"><label for="telefone">Telefone</label><input class="medio" type="tel" name="telefone-juridica" id="telefone-juridica"></li>
                </ul>
              </li>
              <li>
                <ul>
                  <li><label for="ddd2">DDD</label><input class="medio" type="tel" name="ddd2-juridica" id="ddd2-juridica"></li>
                  <li><label for="telefone2">Outro telefone</label><input class="medio" type="tel" name="telefone2-juridica" id="telefone2-juridica"></li>
                </ul>
              </li>
            </ol>
		  </section>
          ...
          <section>
            ...
            <ol>
              <li class="obrigatorio">
                ...
                <ul>
                  <li><input class="cep" type="text" name="cep1" id="cep1" title="Digite o CEP"></li>
                  <li><input class="cep-menor" type="text" name="cep2" id="cep2" title="Digite o CEP"></li>
                </ul>
              </li>
              <li>
                <ul>
                  <li class="obrigatorio"><label for="endereco">Endereço</label><input class="grande" type="text" name="endereco" id="endereco"></li>
                  <li class="obrigatorio"><label for="endereco-numero">Número</label><input class="cep" type="text" name="endereco-numero" id="endereco-numero"></li>
                </ul>
              </li>
              <li>
                <ul>
                  <li><label for="complemento">Complemento</label><input class="medio" type="text" name="complemento" id="complemento"></li>
                  <li class="obrigatorio"><label for="bairro">Bairro</label><input class="medio" type="text" name="bairro" id="bairro"></li>
                </ul>
              </li>
              <li>
                <ul>
                      ...
                      <select name="estado" id="estado">
                        <?php
                        	for ($_i=0; $_i < count($_arrayUf); $_i++) { 
								echo "<option value=\"" . $_arrayUf[$_i] . "\" " . ($_arrayUf[$_i]=="PR"?"selected=\"selected\"":"") . ">" . $_arrayUf[$_i] . "</option>";
							}
                        ?>
                      </select>
                    </div>
                  </li>
                  <li class="obrigatorio"><label for="cidade">Cidade</label><input class="medio" type="text" name="cidade" id="cidade"></li>
                </ul>
              </li>
          ...
          <a href="carrinhoLogin.php?voltar=1" class="voltar" title="Voltar à página anterior"><svg width="8px" height="15px"><use xlink:href="#icone-seta" class="icone" /></svg> Voltar</a>
...
<script>
	...
	function mySubmit(){
		...
		myList.push($('input[name=senha]'));
		myList.push($('input[name=confirmacao]'));

  ...
  <div class="limites">
    ...
    <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
      <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
        <a itemprop="item" href="<?php echo URL; ?>index"><span itemprop="name">plander.com</span></a>
        <meta itemprop="position" content="1" />
      </li>
      <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
        <a itemprop="item" href="<?php echo URL; ?>politicaEntrega"><span itemprop="name">Política de entrega</span></a>
    ...
    <aside class="coluna">
      <div>
        <ul>
          <li><a href="<?php echo URL; ?>politicas#privacidade" title="Navegar até este item">Privacidade</a></li>
          <li><a href="<?php echo URL; ?>politicas#pagamento" title="Navegar até este item">Pagamento</a></li>
          <li><a href="<?php echo URL; ?>politicas#garantia" title="Navegar até este item">Garantia</a></li>
          <li><a href="<?php echo URL; ?>politicas#entrega" title="Navegar até este item">Entrega</a></li>
          <li><a href="<?php echo URL; ?>politicas#trocas" title="Navegar até este item">Trocas e devoluções</a></li>
        </ul>
      </div>
    </aside>
    ...
    <section>
    	<h3 id="privacidade">Privacidade</h3>
      	<p>
	    	Durante sua navegação são recolhidas algumas informações sobre a navegação dos nossos visitantes, como data da visita, endereço IP e tipo de browser. Dados que facilitam análises de estatísticas e permitindo a nossos visitantes uma navegação mais segura.
			Ao efetuar compra de qualquer produto, é necessários alguns dados pessoais (nome, endereço, cidade, entre outros) que são de importância para identificarmos quem você é e podermos finalizar o seu pedido. Em casos de compras com cartão de crédito, pode ser preciso a confirmação de alguns informação com as administradoras dos cartões ou com o próprio titular do cartão via telefone.
	    </p>
      	<h3 id="pagamento">Pagamento</h3>
      	<p>
	    	É possível comprar em nossa loja física e televendas com as mesmas condições do site.
	    </p>
	    <p>
			<strong>Importante : Cartão de Credito AmericanExpress  aceitamos somente nas compras da loja física.</strong>
		</p>
			Você pode pagar seu pedido através de: Boleto à vista com vencimento em 3 dias corridos e Cartão de crédito da bandeira Visa e MasterCard.
		</p>
	    <p>
	 		* Atenção, para compras em nossa loja física e televendas disponibilizamos de mais opções de pagamento, consulte nossa equipe.
	 	</p>
	 	
		<h3 id="garantia">Garantia</h3>
		<p>
			Nosso prazo de garantia para produtos novos  é de 3 meses em  caso de defeito de fabricação.
		</p>
		
		<h3 id="entrega">Entrega</h3>
		<p>
			<strong>Como posso consultar o andamento da entrega do meu pedido?</strong>
		</p>
		<p>
			Após a postagem, será encaminhado para o e-mail de cadastro o código de rastreio, caso não receba verifique a caixa de spam ou entre em contato com a nossa equipe.
		</p>
		<p>
			<strong>Posso alterar o endereço de entrega do meu pedido?</strong>
		</p>
		<p>
			A alteração do endereço poderá ser feita até o momento da emissão da Nota Fiscal. Nesse caso é necessário que entre em contato com nossa equipe o mais breve possível para consultar a possibilidade de alterar o endereço. Caso haja diferença no valor do frete essa deverá ser paga pelo cliente.
		</p>
		<p>
			<strong>Preenchi o endereço incorreto e meu pedido já está em poder da transportadora. Ainda é possível corrigir os dados?</strong>
		</p>
		<p>
			No caso de envios feitos através dos Correios não será possível corrigir as informações, mas o cliente poderá acompanhar a entrega através do código de rastreio. A transportadora fará tentativa de entrega no endereço informado, caso constate realmente o erro, irá deixar a encomenda disponível para retirada em um centro de distribuição em até 24h. Caso a encomenda retorne para o nosso endereço será necessário pagar pelo novo envio.
		</p>
		<p>
			<strong>É possível agendar uma data e horário para entrega do meu pedido?</strong>
		</p>
		<p>
			Como o serviço de entrega é terceirizado não será possível agendar a entrega. No ato da compra informamos o prazo médio para entrega e o código de rastreio para que o cliente acompanhe o andamento da entrega.
		</p>
		
		<h3 id="trocas">Trocas e devoluções</h3>
		<p>
	    	<strong>Importante: O prazo para troca é de 7 dias após a compra.</strong><br>
			<strong>Todas as ocorrências que envolvam troca ou devolução devem ser comunicadas à Central de Atendimento ao Cliente.</strong>
		</p>
	    <p>
	    	Se ocorrer qualquer das hipóteses abaixo, recuse o recebimento do produto.
	    	<br>
	    ...
	    <p>
			Importante Não efetuamos troca  de palhetas  de nenhum tipo. 
		</p>
	    <p>
			OS CUSTOS DE ENVIO DE MERCADORIAS  REFERENTE A TROCAS  OCORRERÁ POR CONTA DO CLIENTE. 
		</p>
	    <p>
			Em caso de dúvidas envie um e-mail para plander@plander.com.br ou  41 3323-3636  Nosso objetivo é a sua satisfação. Boas compras!
	    </p>
    </section>
  </div>
  <!-- fecha .limites -->

<?php
	...
	$_tituloPagina = "Endereço de Entrega - Carrinho de Compras";
	$_carrinho = true;
...
<div class="carrinho">
  ...
  <div class="conteudo">
    ...
    <div class="limites">
      ...
      <form action="<?php echo URL_SSL; ?>actions/alterarEnderecoEntrega.php" onsubmit="return mySubmit();" method="POST" class="conta">
        <fieldset>
          <section>
            <!--<h3>Dados da empresa</h3>-->
            <ol>
              <!--<li class="erro obrigatorio">-->
              <li>
              	<label for="nome">Nome</label>
              	<input type="text" name="nome" id="nome" value="<?php echo @$_SESSION["ENTREGA"]["nome"]; ?>">
              	<!--<span>Por favor, preencha a razão social da empresa</span>-->
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol>
              <li class="obrigatorio">
                ...
                <ul>
                  <li><input class="cep" type="text" name="cep1" id="cep1" title="Digite o CEP" maxlength="5" value="<?php echo @$_SESSION["ENTREGA"]["cep1"]; ?>"></li>
                  <li><input class="cep-menor" type="text" name="cep2" id="cep2" title="Digite o CEP" maxlength="3" style="width: 50px" value="<?php echo @$_SESSION["ENTREGA"]["cep2"]; ?>"></li>
                </ul>
              </li>
              <li>
                <ul>
                  <li class="obrigatorio"><label for="endereco">Endereço</label><input class="grande" type="text" name="endereco" id="endereco" value="<?php echo @$_SESSION["ENTREGA"]["endereco"]; ?>"></li>
                  <li class="obrigatorio"><label for="endereco-numero">Número</label><input class="cep" type="text" name="endereco-numero" id="endereco-numero"  value="<?php echo @$_SESSION["ENTREGA"]["numero"]; ?>"></li>
                </ul>
              </li>
              <li>
                <ul>
                  <li><label for="complemento">Complemento</label><input class="medio" type="text" name="complemento" id="complemento" value="<?php echo @$_SESSION["ENTREGA"]["complemento"]; ?>"></li>
                  <li class="obrigatorio"><label for="bairro">Bairro</label><input class="medio" type="text" name="bairro" id="bairro" value="<?php echo @$_SESSION["ENTREGA"]["bairro"]; ?>"></li>
                </ul>
              </li>
              <li>
                <ul>
                      ...
                      <select name="uf" id="uf">
                        <?php
                        	for ($_i=0; $_i < count($_arrayUf); $_i++) { 
								echo "<option value=\"" . $_arrayUf[$_i] . "\" " . ((strtoupper(@$_SESSION["ENTREGA"]["uf"])==$_arrayUf[$_i])||@$_SESSION["ENTREGA"]["uf"]==""&&$_arrayUf[$_i]=="PR"?"selected=\"selected\"":"") . ">" . $_arrayUf[$_i] . "</option>";
							}
                        ?>
                      </select>
                    </div>
                  </li>
                  <li class="obrigatorio"><label for="cidade">Cidade</label><input class="medio" type="text" name="cidade" id="cidade" value="<?php echo @$_SESSION["ENTREGA"]["cidade"]; ?>"></li>
                </ul>
              </li>
              <li><label for="pontos">Pontos de referência</label><textarea name="pontos" id="pontos" cols="30" rows="10"><?php echo @$_SESSION["ENTREGA"]["informacoes_referencia"]; ?></textarea></li>
            </ol>
          </section>
          <a href="<?php echo URL_SSL; ?>carrinhoPagamento" class="voltar" title="Voltar à página anterior"><svg width="8px" height="15px"><use xlink:href="#icone-seta" class="icone" /></svg> Voltar</a>
	...
	$(document).ready(function(){
	    ...
	    $("#cep2").keyup(function(e) {
			...
			if (cepCampo1.length == 5 && $("#cep2").val().length == 3) {
				...
				$.ajax({
					URL_SSL: "<?php echo URL_SSL; ?>actions/inputCepXml.php",
					data: dados,

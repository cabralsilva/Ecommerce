<?php
	...
	//define("UrlWs", "http://192.168.100.8:8080/wsplander/");
	define("JUROS", 0.029);
	//define("URL", "http://localhost/www/plander_novo_2016/plander/");
	define("URL", "http://www.plander.com.br/ibolt/homologacao/");
	
	define("SSL", 1); //DEIXAR COMO 1 CASO FOR UM AMBIENTE QUE TENHA CRIPTOGRAFIA, NAO SEJA TESTE
	
	if (SSL==1)
		define("URL_SSL", "https://www.plander.com.br/ibolt/homologacao/");
